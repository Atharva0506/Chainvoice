import{cX as v,c_ as f,c$ as a}from"./web3-vendor-DK4Ms28J.js";import{c as u,n as w,r as d,o as q,U as ve}from"./index-i5pkIOig.js";import{w as fe,s as ge,l as be,p as ye,M as g,m as se,R as l,r as P,n as K,e as ce,k as le,g as m,c as Y,h as xe,o as S,E as ie,O as E,C as F,q as oe,i as T,A as H,T as Ce,t as ke,a as Se,f as We}from"./core-BVtjwUau.js";import"./react-vendor-B4yWqigs.js";import"./mui-vendor-B0y3yxJk.js";import"./lit-vendor-BH5aECpV.js";const p=ye({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Re={state:p,subscribe(r){return be(p,()=>r(p))},subscribeKey(r,e){return ge(p,r,e)},showTooltip({message:r,triggerRect:e,variant:t}){p.open=!0,p.message=r,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},O=fe(Re),de={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){g.shake();return}if(await se.isSIWXCloseDisabled()){g.shake();return}g.close()}},$e=v`
  :host {
    display: block;
